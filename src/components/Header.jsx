            ...
            <div className={`relative w-full md:w-11/12 lg:w-10/12 px-5 text-center md:text-left flex flex-col justify-center min-h-screen`}>
                ...
                <div className="flex flex-col-reverse md:flex-row justify-center items-center">
                    <div className="flex flex-col">
                        <h1 className={`text-black underline font-open-sans text-5xl fade-in z-30`} style={{lineHeight: '4rem'}}>
                            Bring Your Ideas to Life
                        </h1>
                        <div className='mt-2 z-30 uppercase'>
                            <h2 className={`text-green-600 text-2xl fade-in letter-spacing-1 animate-pulse`}>Realise Your Vision.</h2>
                        </div>
                    ...
                    <Brand logo={Logo1} alt="Logo" width={1923} height={1923} url='/' className={'w-8/12 sm:w-5/12 md:w-6/12 lg:w-5/12'} style={{height: 'auto'}}/>
                </div>
                <div className="absolute text-center text-4xl bottom-2 md:bottom-5 right-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 w-7 border-2 border-black rounded-2xl rotate-180 animate-pulse">
                    .
                </div>
            </div>
        </header>
